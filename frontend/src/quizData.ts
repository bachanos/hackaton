...
export const unifiedQuizQuestions: UnifiedQuestion[] = [
  // Pregunta tipo imagen con respuestas texto (ImageQuiz)
  {
    ...
    questionText: 'Esta imagen del Telescopio Espacial James Webb muestra los "Pilares de la Creación". ¿En qué nebulosa se encuentran?',
    questionImageUrl: 'https://stsci-opo.org/STScI-01G8GAB346P5V1P3X32S2BFJ2C.png',
    answers: [
      'Nebulosa de Orión',
      'Nebulosa del Águila',
      'Nebulosa del Cangrejo',
  ...
  // Pregunta tipo texto con respuestas imagen (Quiz original)
  {
    ...
    correctAnswerId: 2,
    explanation: 'Marte es conocido como el "Planeta Rojo" debido a la gran cantidad de óxido de hierro en su superficie, que le da su característico color rojizo.',
  },
  // Otra pregunta tipo imagen con respuestas texto
  {
    id: 3,
    type: 'image-with-text',
    questionText: 'La galaxia en esta imagen, conocida como "Rueda de Carro", es un ejemplo de un tipo raro de galaxia. ¿Cuál es?',
    questionImageUrl: 'https://stsci-opo.org/STScI-01G695Q1K1J1V4PE19T4V32D4B.png',
    answers: [
      'Galaxia espiral',
      'Galaxia elíptica',
      'Galaxia lenticular',
    ...
    answers: [
      {
        id: 1,
        text: 'Vesta',
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Vesta_in_true_color.jpg/800px-Vesta_in_true_color.jpg',
      },
      {
        id: 2,
        text: 'Pallas', 
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Pallas-HST-2007.jpg/320px-Pallas-HST-2007.jpg',
      },
      {
        id: 3,
        text: 'Ceres',
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Ceres_-_RC3_-_Haulani_Crater_%2822359932521%29.jpg/800px-Ceres_-_RC3_-_Haulani_Crater_%2822359932521%29.jpg',
      },
      {
        id: 4,
        text: 'Hygiea',
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Hygiea_map.png/320px-Hygiea_map.png',
      },
    ],
    correctAnswerId: 3,
